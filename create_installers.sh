...
# Direct installer creation script for SonoBus
echo "=== Creating SonoBus Distribution Installers ==="
...
if [ -f "images/sonobus_icon_mac_256.png" ]; then
    cp "images/sonobus_icon_mac_256.png" "$INSTALL_DIR/share/pixmaps/sonobus.png"
else
    # Create a simple placeholder icon
    echo "Creating placeholder icon..."
    cat > "$INSTALL_DIR/share/pixmaps/sonobus.svg" << 'EOF'
<?xml version="1.0" encoding="UTF-8"?>
<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
  <circle cx="32" cy="32" r="28" fill="#4CAF50"/>
  <text x="32" y="38" text-anchor="middle" fill="white" font-size="16" font-family="sans-serif">SB</text>
</svg>
EOF
fi
...
echo "Starting SonoBus Enhanced for macOS..."
...
echo "SonoBus Enhanced macOS installer package"
EOF
...
echo Starting SonoBus Enhanced for Windows...
...
echo SonoBus Enhanced Windows installer package
pause
EOF
